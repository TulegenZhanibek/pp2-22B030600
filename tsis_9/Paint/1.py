...
def setsurf():
    ...
    tr1 = pg.image.load(r"C:\pp2\tsis_9\Paint\right_triangle.png")
    buttons.blit(tr1, (8, 8))
    tr2 = pg.image.load(r"C:\pp2\tsis_9\Paint\equilateral-triangle.png")
    buttons.blit(tr2, (8, 55))
    pg.draw.rect(buttons, 'black', (58, 10, 32, 32), 2)
    rh = pg.image.load(r"C:\pp2\tsis_9\Paint\rhombus.png")
